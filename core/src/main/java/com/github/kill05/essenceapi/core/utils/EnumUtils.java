...
public final class EnumUtils {
    ...
    public static <E extends Enum<E>> E getPrevious(Class<E> enumClass, E value) {
        E[] values = enumClass.getEnumConstants();
        int newIndex = (value.ordinal() == 0 ? values.length - 1 : value.ordinal() - 1);
        return values[newIndex];
    }

    public static <E extends Enum<E>> E getNext(Class<E> enumClass, E value) {
        E[] values = enumClass.getEnumConstants();
        int newIndex = (value.ordinal() == values.length - 1 ? 0 : value.ordinal() + 1);
        return values[newIndex];
    }
}
