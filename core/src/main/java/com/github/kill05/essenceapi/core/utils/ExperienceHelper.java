...
public class ExperienceHelper {
     ...
     */
    public ExperienceHelper(Player player) {
    ...
    public static void setHardMaxLevel(int hardMaxLevel) {
        ExperienceHelper.hardMaxLevel = hardMaxLevel;
    }

    /**
     * Initialize the XP lookup table. See <a href="http://minecraft.gamepedia.com/Experience">http://minecraft.gamepedia.com/Experience</a>
     *
     ...
     * Works around some non-intuitive behaviour of the basic Bukkit
